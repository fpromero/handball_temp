...
columns_out = ["Player1", "Player2",  "Player3"] + columns_kpi
df_pm_out = pd.DataFrame(columns = columns_out )

c1 = pd.Series(['09-E. BOADA', '27-S. ARDERIUS', '03-E. ARROJERIA' ,0,0,0,0,0,0,0,0], index = df_pm_out.columns)
c2 = pd.Series(['09-E. BOADA', '04-M. FERNANDES', '03-E. ARROJERIA' ,0,0,0,0,0,0,0,0], index = df_pm_out.columns)
c3 = pd.Series(["05-M. PIZZO",  "08-A. MENENDEZ", "09-E. BOADA", 0,0,0,0,0,0,0,0], index = df_pm_out.columns)
...
df_pm_out.to_excel(data_path + file_name + "_plusminus_trios.xls", columns = columns_out)
