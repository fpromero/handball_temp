...
cols_pos = ["9mGoal", "6mGoal", "FBGoal", "7mGoal", "WingGoal", "EGGoal"
            "Assist", "Received7m", "Provoke2m", "Steal","GoodDef", "Block"]
w_pos = [1.5, 1, 1, 1, 1,1,
            0.85, 1, 0.8, 1, 0.8, 0.8]

cols_neg = ["9mSave", "9mOut", "9mBlock", 
            "6mSave", "6mOut", "WingSave", "WingOut"
            "FBSave", "FBOut", "EGSave", "EGOut"
...
cols_gk_pos =  ["9mSave", "9mOut" , "6mSave",  "6mOut", "WingSave", "WingOut", "FBSave", "FBOut","7mSave", "7mOut", "EGGoal", "Assist", "Received7m", "Provoke2m", "Steal"]
cols_gk_neg = ["9mGoal", "6mGoal", "FBGoal", "7mGoal","EGSave", "EGOut", "Turnover", "DefMistake",  "2mJ", "2mBB", "RedBlueCard"]
